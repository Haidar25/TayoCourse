	...
	<div class="container">
	    <div class="row">
	        <div class="col-sm-6 col-md-4 col-md-offset-4">
				<center>   
			<h5 style="color:white;">Masuk ke Dashboard Tayo Course</h5>
				</center>
	            <div class="account-wall">
					<center> <img src="assets/img/login.png" /></center>
				...
				<br><center>
				<a href="home.php" class="btn btn-warning" role="button">Kembali Ke Home</a>
				</center>
				    </div>
	    </div>
	</div>
