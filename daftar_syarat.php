...
<head>
    ...
    <title>Penerimaan Peserta Baru Bimbel Tayo </title>
            ...
            <div class="col-sm-12 col-md-8 col-lg-10 col-lg-offset-1">
                <div class="card" style="margin-top: 50px">
                    ...
                    <div class="card-content">
                        <h3>Berikut adalah syarat pendaftaran Bimbel Tayo baru yang harus dipenuhi :</h3>
                        <ol>
            ...
            <div class="col-sm-12 col-md-8 col-lg-10 col-lg-offset-1">
                <div class="card" style="margin-top: 50px">
                    ...
                    <div class="card-content table-responsive">
                        ...
                        <h3 style="overflow: hidden;"><b>Data Calon Peserta Bimbel Tayo</b></h3>
