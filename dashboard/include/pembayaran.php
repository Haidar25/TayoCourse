    ...
    <div class="col-sm-12 col-md-8 col-lg-10 col-lg-offset-1">
        <div class="card" style="margin-top: 50px">
            ...
            <ol>
            	...
            	<li>Perhitungan Usia akan di hitung otomatis oleh sistem, tegantung dari usia yang telah diinputkan dalam form pendaftaran siswa secara online sebelumnya oleh pendaftar</li>
            </ol>    
			...
			<ol>
				...
				<table class="table table-responsive table-hove">
					...
					<tbody>
						<tr>
							<td>Uang alat tulis dan seragam bimbel</td>
							<td align="right">350.000</td>
						</tr>
						<tr>
							<td>Uang Administrasi dan keperluan lainya</td>
