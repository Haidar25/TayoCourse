    ...
    <div class="col-sm-12 col-md-8 col-lg-10 col-lg-offset-1">
        <div class="card" style="margin-top: 50px">
            <div class="card-header" data-background-color="blue">
                <h4 class="title">Tentor</h4>
                <p class="category">Daftar Tentor pada Bimbel Tayo</p>
            </div>
            <div class="card-content">
                <a href="index.php?page=11" class="btn btn-primary btn-md pull-right"><i class="fa fa-plus"></i> Tambah Tentor</a>
                <h3 style="overflow: hidden;"><b>Data Tentor</b></h3>
				<table class="table table-hover">
					<thead>
						<tr>
							<td><b>No</b></td>
							<td><b>NIP</b></td>
							<td><b>Nama Tentor</b></td>
							<td><b>Telp</b></td>
							<td><b>Alamat</b></td>
							<td><b>Aksi</b></td>
						</tr>
